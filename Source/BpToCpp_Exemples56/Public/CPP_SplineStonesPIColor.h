...
#include "CPP_SplineStonesPIColor.generated.h"

UCLASS()
class BPTOCPP_EXEMPLES56_API ACPP_SplineStonesPIColor : public AActor
{
	GENERATED_BODY()
	
public:	
	// Sets default values for this actor's properties
	ACPP_SplineStonesPIColor();
	...
	UMaterialInterface* PICD_Material;
